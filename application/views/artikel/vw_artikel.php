      ...
      <div class="col-lg-7 px-0">
        <div class="owl-carousel main-carousel position-relative">
          <div class="position-relative overflow-hidden" style="height: 500px;">
            <img src="<?= base_url('assets/images/news-800x500-1.jpg') ?>" alt="Form Logo" class="logo">
            <div class="overlay">
              <div class="mb-2">
          ...
          <div class="position-relative overflow-hidden" style="height: 500px;">
            <img src="<?= base_url('assets/images/news-800x500-2.jpg') ?>" alt="Form Logo" class="logo">
            <div class="overlay">
              <div class="mb-2">
                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="">Business</a>
                <a class="text-white" href="">Jan 01, 2045</a>
          ...
          <div class="position-relative overflow-hidden" style="height: 500px;">
            <img src="<?= base_url('assets/images/news-800x500-3.jpg') ?>" alt="Form Logo" class="logo">
            <div class="overlay">
              <div class="mb-2">
                <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="">Business</a>
                <a class="text-white" href="">Jan 01, 2045</a>
        ...
        <div class="row mx-0">
          <div class="col-md-6 px-0">
            <div class="position-relative overflow-hidden" style="height: 250px;">
              <img src="<?= base_url('assets/images/news-700x435-1.jpg') ?>" alt="Form Logo" class="logo">
              <div class="overlay">
                <div class="mb-2">
                  <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="">Business</a>
          ...
          <div class="col-md-6 px-0">
            <div class="position-relative overflow-hidden" style="height: 250px;">
              <img src="<?= base_url('assets/images/news-700x435-2.jpg') ?>" alt="Form Logo" class="logo">
              <div class="overlay">
                <div class="mb-2">
                  <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="">Business</a>
                  <a class="text-white" href=""><small>Jan 01, 2045</small></a>
          ...
          <div class="col-md-6 px-0">
            <div class="position-relative overflow-hidden" style="height: 250px;">
              <img src="<?= base_url('assets/images/news-700x435-3.jpg') ?>" alt="Form Logo" class="logo">
              <div class="overlay">
                <div class="mb-2">
                  <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="">Business</a>
                  <a class="text-white" href=""><small>Jan 01, 2045</small></a>
          ...
          <div class="col-md-6 px-0">
            <div class="position-relative overflow-hidden" style="height: 250px;">
              <img src="<?= base_url('assets/images/news-700x435-4.jpg') ?>" alt="Form Logo" class="logo">
              <div class="overlay">
                <div class="mb-2">
                  <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="">Business</a>
                  <a class="text-white" href=""><small>Jan 01, 2045</small></a>
    ...
    <div class="container">
      ...
      <div class="owl-carousel news-carousel carousel-item-4 position-relative">
        <div class="position-relative overflow-hidden" style="height: 300px;">
          <img src="<?= base_url('assets/assets/images/news-700x435-1.jpg')  ?>" alt="Form Logo" class="img-fluid h-100">
          <div class="overlay">
            <div class="mb-2">
              <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="">Business</a>
              <a class="text-white" href=""><small>Jan 01, 2045</small></a>
        ...
        <div class="position-relative overflow-hidden" style="height: 300px;">
          <img src="<?= base_url('assets/assets/images/news-700x435-2.jpg') ?>" alt="Form Logo" class="logo">
          <div class="overlay">
            <div class="mb-2">
              <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="">Business</a>
              <a class="text-white" href=""><small>Jan 01, 2045</small></a>
        ...
        <div class="position-relative overflow-hidden" style="height: 300px;">
        <img src="<?= base_url('assets/assets/images/news-700x435-3.jpg') ?>" alt="Form Logo" class="logo">
          <div class="overlay">
            <div class="mb-2">
              <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="">Business</a>
              <a class="text-white" href=""><small>Jan 01, 2045</small></a>
        ...
        <div class="position-relative overflow-hidden" style="height: 300px;">
        <img src="<?= base_url('assets/assets/images/news-700x435-4.jpg') ?>" alt="Form Logo" class="logo">
          <div class="overlay">
            <div class="mb-2">
              <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="">Business</a>
              <a class="text-white" href=""><small>Jan 01, 2045</small></a>
        ...
        <div class="position-relative overflow-hidden" style="height: 300px;">
        <img src="<?= base_url('assets/assets/images/news-700x435-5.jpg') ?>" alt="Form Logo" class="logo">
          <div class="overlay">
            <div class="mb-2">
              <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="">Business</a>
              <a class="text-white" href=""><small>Jan 01, 2045</small></a>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="position-relative mb-3">
                <img src="<?= base_url('assets/assets/images/news-700x435-1.jpg') ?>" alt="Form Logo" class="img-fluid w-100">
                ...
                <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                  ...
                  <div class="d-flex align-items-center">
                    <small class="ml-3"><i class="far fa-eye mr-2"></i>11111</small>
